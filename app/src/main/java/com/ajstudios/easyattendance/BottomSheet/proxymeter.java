...
public class proxymeter extends RealmRecyclerViewAdapter<Attendance_Reports, ViewHolder_reports> {
    ...
    public proxymeter(RealmResults<Attendance_Reports> list, Activity context, String roomID) {
